...
import static com.example.configrefreshsample.core.CredentialsProviderAutoConfiguration.credentialsProviderQualifier;
import static com.example.configrefreshsample.core.RegionProviderAutoConfiguration.regionProviderQualifier;
...
public class NotificationAutoConfiguration {
    ...
    NotificationDataPlane notificationDataPlaneClient(@Qualifier(regionProviderQualifier) RegionProvider regionProvider,
        ...
        NotificationDataPlane notificationDataPlaneClient = NotificationDataPlaneClient.builder().build(adp);
